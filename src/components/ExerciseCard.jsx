...
export default function ExerciseCard(props){
  ...
  return(
    <div className="flex flex-col p-4 rounded-md gap-4
    bg-slate-950 sm:flex-wrap">
      ...
      sm:items-center sm:flex-wrap gap-x-4">
        ...
        <h2 className="capitalize whitespace-nowrap truncate
         max-w-full text-lg sm:text-xl md:text-2xl flex-1
         sm:text-center">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
        ...
        <button onClick={handleSetIncrement} className="flex flex-col rounded p-2 border-[1.5px] 
        duration-200 border-solid border-blue-900 hover:border-blue-600
        w-full">
