...
import { SCHEMES, WORKOUTS } from "../utils/buffinator";
...
export default function Genarator(props){
  ...
  return(
    <SectionWrapper id={'generate'} header={'generate your workout'} title=
      {['It\'s', 'Huge', 'o\'clock']}>
          ...
          {Object.keys(WORKOUTS).map((type,typeIndex) => {
            return(
              <button onClick={()=>{
                ...
                hover:border-blue-600 py-3 px-4 rounded-lg 
        ...
        <div className="bg-slate-950 border-blue-400 
        border border-solid rounded-lg flex flex-col">
          <button onClick={toggleModal} className="relative p-3 justify-center 
          flex items-center">
        ...
        <Header index={'03'} title={'Become Behemoth'} description={'Select your ultimate objective.'}/>
